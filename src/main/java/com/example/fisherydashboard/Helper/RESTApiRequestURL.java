package com.example.fisherydashboard.Helper;

public class RESTApiRequestURL {
    public static final String GET_HARVESTEDFISHRECORDS = "http://localhost:8080/fishery/getHarvestedFishRecords";
